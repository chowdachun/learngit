...
class Youhua_logic_model:
    ...
    def fit(self):
        ...
        # pred_ls = []
        #
        # with open('/Users/admin/Desktop/df_ls.pkl','wb') as g:
        #     pickle.dump(df_ls,g)
        # with open('/Users/admin/Desktop/pred_ls.pkl','wb') as k:
        #     pickle.dump(pred_ls,k)
        # with open('/Users/admin/Desktop/df_yuan_ls.pkl','wb') as j:
        ...
        for i in range(self.back + 1):  # 储存预测结果back+1个df
            ...
            # x_train.to_csv('/Users/admin/Desktop/x_train.csv')

            # # logic算法预测
            # df_pred_first = self.logi_regression \
            #     (x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test, x_pred=x_pred,
            #      x_pred_first=df_yuan_ls[i])

            #DNN神经网络yuc
            df_pred_first = skfunc.dnn_minmax(x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test, x_pred=x_pred,
                 x_pred_first=df_yuan_ls[i])
...
if __name__ == '__main__':
    ...
    route_id = None
    to_path = "/Users/admin/Desktop/测试_近10天用户流失预测_20230821.csv"
